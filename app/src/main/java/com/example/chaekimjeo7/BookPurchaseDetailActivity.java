...
public class BookPurchaseDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_home) {
                Intent homeIntent = new Intent(BookPurchaseDetailActivity.this, MainActivity.class);  // ✅ 이름 다르게
                homeIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP | Intent.FLAG_ACTIVITY_SINGLE_TOP);
                startActivity(homeIntent);
                finish();
                return true;
            } else if (id == R.id.nav_chat) {
                Intent chatIntent = new Intent(BookPurchaseDetailActivity.this, ChatListActivity.class);
